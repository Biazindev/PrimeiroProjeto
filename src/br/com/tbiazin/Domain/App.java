...
public class App {
	    ...
	    private static void atualizar(String dados) {
	        ...
	        Clientes cliente = new Clientes(dadosSeparados[0],dadosSeparados[1],dadosSeparados[2],dadosSeparados[3],dadosSeparados[4],dadosSeparados[5],dadosSeparados[6]);
	    ...
	    private static void consultar(String dados) {
	        Clientes cliente = iClienteDAO.consultar(Long.parseLong(dados));
	        if (cliente != null) {
	    ...
	    private static void sair() {
	        ...
	        for (Clientes cliente : iClienteDAO.buscarTodos()) {
